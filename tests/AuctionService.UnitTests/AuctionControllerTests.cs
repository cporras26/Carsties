...
public class AuctionControllerTests
{
    ...
    public async Task GetAuctions_WithNoParams_Returns10Auctions()
    {
        ...
        _auctionRepository.Setup(repo => 
            repo.GetAuctionsAsync(null)).ReturnsAsync(auctions);
    ...
    public async Task GetAuctionById_WithValidGuid_ReturnsAuction()
    {
        ...
        _auctionRepository.Setup(repo => 
            repo.GetAuctionByIdAsync(It.IsAny<Guid>())).ReturnsAsync(auction);
    ...
    [Fact]
    public async Task GetAuctionById_WithInvalidGuid_ReturnsNoContent()
    {
        // arrange
        _auctionRepository.Setup(repo => 
            repo.GetAuctionByIdAsync(It.IsAny<Guid>())).ReturnsAsync(value: null);
    ...
    public async Task UpdateAuction_WithUpdateAuctionDto_ReturnsOkResponse()
    {
        ...
        _auctionRepository.Setup(repo
            => repo.GetAuctionEntityById(It.IsAny<Guid>())).ReturnsAsync(auction);
        _auctionRepository.Setup(repo =>
            repo.SaveChangesAsync()).ReturnsAsync(true);
    ...
    public async Task UpdateAuction_WithInvalidGuid_ReturnsNotFound()
    {
        ...
        _auctionRepository.Setup(repo
            => repo.GetAuctionEntityById(It.IsAny<Guid>())).ReturnsAsync(value: null);
    ...
    [Fact]
    public async Task DeleteAuction_WithInvalidGuid_ReturnsNoContent()
    {
        // arrange
        _auctionRepository.Setup(repo
            => repo.GetAuctionEntityById(It.IsAny<Guid>())).ReturnsAsync(value: null);
